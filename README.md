...
Tagmania is a mini-language designed for matching or transforming lists consisting of tuples or NLTK trees (henceforth 'chunks'). The transformations tagmania can peform are the following:
 ...
 - Adding da special "clause opening" or "clause closing" chunk with a specified tag
...
Imagine you would like to search for list of words, but within the framework of tagmania. I.e. Instead of writing 
